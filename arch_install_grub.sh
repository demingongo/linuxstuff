...
echo
echo "   1. Mount the partitions from which the other systems boot (e.g.: mkdir /mnt/fedora && mount /mnt/sxyz /mnt/fedora)"
echo "      (The exact mount point does not matter)"
echo
